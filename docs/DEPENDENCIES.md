...
| **`leaflet`** (`^1.9.4`) | Biblioteca JavaScript ligera para mapas interactivos y vectoriales. | `src/components/common/MapComponent.jsx` | Inicialización de mapa, polígonos, capas de teselas (Carto, OSM, Esri), marcadores y popups. |
